...
public class Gapples extends HudModule {
    ...
    public Gapples() {
        super("Gapples", "Shows you how many gapples you have in your inventory", new Point(60, 100), Category.HUD);
    }
    ...
    private class GapplesList implements HUDList {
        ...
        public String getItem(int index) {
            totems = InventoryUtils.findItemWithCount(Items.ENCHANTED_GOLDEN_APPLE).count;
            return "Gapples: " + Formatting.GRAY + totems;
        }
